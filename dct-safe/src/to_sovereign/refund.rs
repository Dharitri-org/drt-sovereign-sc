...
{
    /// Claim funds for failed Dharitri -> Sovereign transactions.
    ...
    fn claim_refund(&self, token_id: TokenIdentifier) -> ManagedVec<DctTokenPayment> {
    ...
    fn mark_refund(&self, to: &ManagedAddress, token: &DctTokenPayment) {
